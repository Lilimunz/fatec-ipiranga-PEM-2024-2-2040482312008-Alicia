...
int main() {
	...
	char* tabuleiro[8][8] = {
		{"tP1", "cP1", "bP1", "dP", "rP", "pP2", "cP2", "tP2"}, //linha da torre, cavalo, bispo, rei e dama - pretas
		...
		{"tB1", "cB1", "bB1", "dB", "rB", "dB2", "cB2", "tB2"}// linha da torre, cavalo, bispo, rei e dama - brancas
	};
